    ...
    static void Main()
    {
        ...
        while (true)
        {
            try
            {
                ...
                string read_type = Console.ReadLine();
                if (read_type.Trim() == "1")
                {
                ...
                if (read.Trim() == "1")
                {
                    ...
                    else if (read_Flight.Trim() == "2" && read_type.Trim() == "2")
                    {
                    ...
                    else if (read_Flight.Trim() == "2" && read_type.Trim() == "1")
                    {
                                Console.WriteLine("Please Select how you Search Flights:" + "\n"
                                    + "1.Price" + "\n"
                                    + "2.Departure Country" + "\n"
                    ...
                    string read_search = Console.ReadLine();
                            ...
                            switch (read_search)
                            {
                                case "1":
                                    ...
                                    if (flight_price.Count != 0 && read_type == "2")
                                    {
                                        Console.WriteLine("Are your Sure Book Flight?(y\\n)");
                                        string read_book = Console.ReadLine();
                                        if (read_book == "y")
                                ...
                                case "2":
                                    ...
                                    List<Flights>? flight_DepartureCountry =
                                        passenger.Search_for_DepartureCountry(read_DepartureCountry);
                                    foreach (var res_price in flight_DepartureCountry)
                                    {
                                        Console.WriteLine(res_price.ToString());
                                    }

                                    if (flight_DepartureCountry.Count != 0 && read_type == "2")
                                    {
                                        Console.WriteLine("Are your Sure Book Flight?(y\\n)");
                                        string read_book = Console.ReadLine();
                                        if (read_book == "y")
                                ...
                                case "3":
                                    ...
                                    List<Flights>? flight_DestinationCountry =
                                        passenger.Search_for_DestinationCountry(read_DestinationCountry);
                                    foreach (var res_price in flight_DestinationCountry)
                                    {
                                        Console.WriteLine(res_price.ToString());
                                    }

                                    if (flight_DestinationCountry.Count != 0 && read_type == "2")
                                    {
                                        Console.WriteLine("Are your Sure Book Flight?(y\\n)");
                                        string read_book = Console.ReadLine();
                                        if (read_book == "y")
                                ...
                                case "4":
                                    ...
                                    if (flight_DepartureDate.Count != 0 && read_type == "2")
                                    {
                                        Console.WriteLine("Are your Sure Book Flight?(y\\n)");
                                        string read_book = Console.ReadLine();
                                        if (read_book == "y")
                                ...
                                case "5":
                                    ...
                                    List<Flights>? flight_DepartureAirport =
                                        passenger.Search_for_Departure_Airport(read_Departure_Airport);
                                    foreach (var res_price in flight_DepartureAirport)
                                    {
                                        Console.WriteLine(res_price.ToString());
                                    }

                                    if (flight_DepartureAirport.Count != 0 && read_type == "2")
                                    {
                                        Console.WriteLine("Are your Sure Book Flight?(y\\n)");
                                        string read_book = Console.ReadLine();
                                        if (read_book == "y")
                                ...
                                case "6":
                                    ...
                                    List<Flights>? flight_Arrival_Airport =
                                        passenger.Search_for_Arrival_Airport(read_Arrival_Airport);
                                    foreach (var res_price in flight_Arrival_Airport)
                                    {
                                        Console.WriteLine(res_price.ToString());
                                    }

                                    if (flight_Arrival_Airport.Count != 0 && read_type == "2")
                                    {
                                        Console.WriteLine("Are your Sure Book Flight?(y\\n)");
                                        string read_book = Console.ReadLine();
                                        if (read_book == "y")
                                ...
                                case "7":
                                    ...
                                    if (flight_Class.Count != 0 && read_type == "2")
                                    {
                                        Console.WriteLine("Are your Sure Book Flight?(y\\n)");
                                        string read_book = Console.ReadLine();
                                        if (read_book == "y")
                                ...
                                case "8":
                                    if (read_type == "1")
                                    {
                                        Console.WriteLine("Please enter Flight:");
                                        string read_flight = Console.ReadLine();
                                        List<Flights>? flights = manager.Search_for_Flight(int.Parse(read_flight));
                                ...
                                case "9":
                                    if (read_type == "1")
                                    {
                                        Console.WriteLine("Please enter Number of Passenger:");
                                        string read_pssenger = Console.ReadLine();
                                        List<Flights>? flight_Passenger = manager.Search_for_Passengers(int.Parse(read_pssenger));
                                        foreach (var flight in flight_Passenger)
                                        {
                                            Console.WriteLine(flight.ToString());
                ...
                else if (read.Trim() == "2" && read_type.Trim() == "2" )
                {
